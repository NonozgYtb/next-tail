 ...
 * Licensed under  ()
 */
export default function owlInit(__jQuery) {
	const _jQuery = __jQuery ?? window.jQuery;
	...
	!(function ___(a, b, c, d) {
		...
		(e.Defaults = {
			...
			(e.prototype.replace = function (b) {
				this.$stage.empty(),
					(this._items = []),
					b && (b = b instanceof _jQuery ? b : a(b)),
					this.settings.nestedItemSelector &&
	...
	})(window.Zepto || _jQuery, window, document),
		(function (a, b, c, d) {
			var e = function (b) {
				(this._core = b),
					(this._interval = null),
